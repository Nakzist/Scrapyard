...
{
    public class TyrantBot : BaseEnemy
    {
        ...
        {
            var tyrantBotData = Resources.Load<TyrantBotScriptableObject>(FolderPaths.TYRANT_BOT_DATA_PATH);

            _attackCooldown = tyrantBotData.AttackCooldown;
            _attackAngle = tyrantBotData.AttackAngle;
            _playerLayerMask = tyrantBotData.PlayerLayerMask;
            
            GetBaseVariables(tyrantBotData);
        }
